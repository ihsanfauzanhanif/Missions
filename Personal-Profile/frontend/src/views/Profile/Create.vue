    ...
    <div class="text-start">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Create Profile Data</div>
                        <div class="card-text mt-4">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="date" v-model="profile.dob" class="form-control" id="dob">
                                </div>
                                <div class="col-md-12 mb-2">
                ...
                <div class="mt-3 mb-5 float-end">
                    <button class="btn btn-primary py-3 px-4" type="submit">Create Profile</button>
                </div>
            </div>
        </div>
    </div>
...
export default defineComponent({
    ...
    setup() {
        ...
        function create() {
            const url = `http://localhost:3000/api/profile/create`
            const formData = {
